...
const Order = ({ order }) => {
  ...
  const statusClass = (index) => {
    ...
    if (index - status === 1) return "animate-pulse text-red-500";
    if (index - status > 1) return "";
  };
  return (
      ...
      <div className="min-h-[calc(100vh_-_433px)] flex  justify-center items-center flex-col p-10  min-w-[1000px]">
        <div className=" flex items-center flex-1  w-full max-h-28">
          <table className="w-full text-sm text-center text-gray-500">
            ...
            <tbody>
              <tr className="transition-all bg-fourth border-gray-700 hover:bg-primary ">
        ...
        <div className="flex justify-between w-full p-10 bg-fourth mt-6">
