...
import CustomerItem from "pages/component/customer/CustomerItem";
...
const Customers = () => {
  ...
  return (
    <div className="container mx-auto mb-20 mt-12">
      <Title addClass="text-[40px] text-primary text-center">What Says Our Customers</Title>
      <Slider {...settings}>
        <CustomerItem imgSrc="/images/man1.png" />
        <CustomerItem imgSrc="/images/woman2.png" />
        <CustomerItem imgSrc="/images/woman4.png" />
        <CustomerItem imgSrc="/images/man3.png" />
        </Slider>
    </div>
  );
};
